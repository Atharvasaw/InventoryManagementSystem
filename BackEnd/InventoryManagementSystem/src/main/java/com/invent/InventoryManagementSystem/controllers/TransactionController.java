...
public class TransactionController {
    ...
    public TransactionController(TransactionService transactionService) { // Constructor injection
        this.transactionService = transactionService;
    }

    @PostMapping("/purchase")
    public ResponseEntity<Response> purchaseInventory(@RequestBody @Valid TransactionRequest transactionRequest) {
//    	System.out.println("📥 Incoming Purchase Request: " + transactionRequest);
